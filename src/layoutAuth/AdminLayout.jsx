    ...
    return (
        <>
            <div className="grid grid-cols-1 lg:grid-cols-5 lg:min-h-screen">
                <div className="cursor-pointer w-full bg-white ml-auto flex justify-end items-end   py-2 z-50 pr-3"></div>
                <motion.div className={`${!nav && "top-[-100%] lg:top-0"} z-10 absolute w-full lg:relative lg:col-span-1 lg:bg-BLUE lg:flex justify-center lg:pt-20 lg:leading-[50px] leading-[40px]`}>
                    <motion.ul  animate={(nav && !FullScreen)? "final" : !FullScreen ? "initial" : "" } className="bg-BLUE font-semibold flex flex-col gap-1 md:gap-2 md:p-0 p-3">
